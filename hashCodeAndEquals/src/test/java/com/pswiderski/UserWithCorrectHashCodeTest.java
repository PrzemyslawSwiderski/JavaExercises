...
public class UserWithCorrectHashCodeTest {
    ...
    public void mapHashCodeInsertingTests() {
        ...
        for (int i = 0; i < testNumber; i++) {
            ...
            Map<User, String> users =
                    testHelper.getRandomUsersMap(20000, 17500, CORRECT_HASH_CODE);
    ...
    public void mapHashCodeGetTest() {
        ...
        User user1 = new UserWithCorrectHashCode();
        user1.setId("1");
        user1.setAge(12);
        user1.setUsername("user1");

        User user2 = new UserWithCorrectHashCode();
        user2.setId("2");
        user2.setAge(32);
        user2.setUsername("user2");

        User user3 = new UserWithCorrectHashCode();
        user3.setId("3");
        user3.setAge(45);
        user3.setUsername("user3");

        User userSameAs1 = new UserWithCorrectHashCode();
        userSameAs1.setId("1");
        ...
        assertNotNull(users.get(userSameAs1));
